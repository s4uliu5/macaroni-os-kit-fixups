...
MY_PV=${PV/_/-}
GIT_COMMIT=59118bff50
inherit linux-info systemd udev golang-base golang-vcs-snapshot user
...
RDEPEND="
	...
	dev-libs/libltdl
	>=app-emulation/containerd-1.6.19[apparmor?,btrfs?,device-mapper?,seccomp?]
