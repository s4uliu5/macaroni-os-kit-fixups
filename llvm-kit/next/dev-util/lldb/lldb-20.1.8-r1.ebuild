...
SLOT="20"
KEYWORDS="*"
IUSE="debug debuginfod +libedit lzma ncurses +python +xml"
...
src_configure() {
	...
	use debug || local -x CPPFLAGS="${CPPFLAGS} -DNDEBUG"
	 local mycmakeargs=(
	  -DLLVM_ROOT="/usr/lib/llvm/20"
	  -DClang_ROOT="/usr/lib/llvm/20"
