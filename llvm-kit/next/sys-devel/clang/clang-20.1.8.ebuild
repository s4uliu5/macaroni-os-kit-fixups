...
DEPEND="~sys-devel/llvm-20.1.8:20[debug=]
...
PDEPEND="sys-devel/clang-common
	~sys-devel/clang-runtime-20.1.8
	default-compiler-rt? (
	  =sys-libs/compiler-rt-${PV%_*}*
	  llvm-libunwind? ( sys-libs/llvm-libunwind )
	  !llvm-libunwind? ( sys-libs/libunwind )
	)
	default-libcxx? ( >=sys-libs/libcxx-20.1.8 )
...
src_configure() {
	...
	local clang_version=20

	local distr_components="bash-autocomplete;clang-cmake-exports;clang-headers;clang-resource-headers;libclang-headers;libclang-python-bindings;aarch64-resource-headers;arm-common-resource-headers;arm-resource-headers;core-resource-headers;cuda-resource-headers;hexagon-resource-headers;hip-resource-headers;hlsl-resource-headers;mips-resource-headers;opencl-resource-headers;openmp-resource-headers;ppc-htm-resource-headers;ppc-resource-headers;riscv-resource-headers;systemz-resource-headers;utility-resource-headers;ve-resource-headers;webassembly-resource-headers;windows-resource-headers;x86-resource-headers;clang-cpp;libclang;amdgpu-arch;c-index-test;clang;clang-format;clang-offload-bundler;clang-offload-packager;clang-refactor;clang-repl;clang-scan-deps;diagtool;hmaptool;nvptx-arch;clang-tblgen"
	if use extra ; then
		distr_components="${distr_components};clang-apply-replacements;clang-change-namespace;clang-doc;clang-include-cleaner;clang-include-fixer;clang-move;clang-query;clang-reorder-fields;clang-tidy;clang-tidy-headers;clangd;find-all-symbols;modularize;pp-trace"
	fi
	...
	local mycmakeargs=(
		...
		# disable tests because needs llvm-gtest
...
src_install() {
	...
	#mv "${ED}"/usr/lib/clang/${SLOT}/$(get_libdir)/clang "${ED}"/usr/include/clangrt || die
