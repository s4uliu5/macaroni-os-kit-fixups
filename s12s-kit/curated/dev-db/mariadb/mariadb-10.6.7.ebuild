...
src_prepare() {
	...
	eapply "${FILESDIR}"/10.6.7/0001-cmake-build-without-client-libs-and-tools.patch
	eapply "${FILESDIR}"/10.6.7/0002-libmariadb-fix-mysql_st-API-regression.patch
	eapply "${FILESDIR}"/10.6.7/0003-libmariadb-cmake-find-GSSAPI-via-pkg-config.patch
	eapply "${FILESDIR}"/10.6.7/0004-cmake-don-t-install-mysql-d-.service-symlinks.patch
	# eapply "${FILESDIR}"/10.6.7/0005-improve-checks-for-libatomic-linking.patch
