...
GIT_COMMIT=752c4f11ae86effa9a46f017f2feb66730c67ed8
MY_PV=v${PV/_rc/-rc.}
...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go v55.8.0+incompatible/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.40.10/go.mod"
	...
	"github.com/digitalocean/godo v1.64.2/go.mod"
	...
	"github.com/google/pprof v0.0.0-20210726183535-c50bf4fe5303/go.mod"
	...
	"github.com/gophercloud/gophercloud v0.19.0/go.mod"
	...
	"github.com/hetznercloud/hcloud-go v1.28.0/go.mod"
	...
	"github.com/linode/linodego v0.31.0/go.mod"
...
SRC_URI="https://github.com/prometheus/prometheus/archive/${MY_PV}.tar.gz -> ${P}.tar.gz
	https://www.s12s.xyz/funtoo/distfiles/${CATEGORY}/${PN}/${P}-asset.tar.xz
	${EGO_SUM_SRC_URI}"
