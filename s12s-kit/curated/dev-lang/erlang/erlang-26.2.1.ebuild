...
inherit elisp-common flag-o-matic java-pkg-opt-2 toolchain-funcs systemd user wxwidgets
...
src_prepare() {
	...
	# https://bugs.gentoo.org/797886
	# erlang's VM does unsafe casts for ints
