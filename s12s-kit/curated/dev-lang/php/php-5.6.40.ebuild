...
inherit flag-o-matic autotools toolchain-funcs systemd
...
SRC_URI="https://php.net/distributions/${P}.tar.xz
	https://fun.s12s.xyz/distfiles/php-patches-${PATCH_V}.tar.xz"
...
src_prepare() {
	...
	eapply "${patchdir}/"
	eapply "${FILESDIR}/php-5.6.40-fix-icu-true-false.patch"
	eapply "${FILESDIR}/php-5.6.40-fix-icu-true-false-2.patch"
